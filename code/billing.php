<?php
require_once SERVER_URL.'/tarambola/app/shoppingcart/paypal/paypalfunctions.php';
...
if ( $PaymentOption == "PayPal")
{
        ...
        //' Shipping page.
        //'------------------------------------
        $shipToName = "Paulo Fernandes";
        $shipToStreet = "Rua XPTO";
        $shipToStreet2 = ""; //Leave it blank if there is no value
        $shipToCity = "Fafe";
        $shipToState = "Braga";
        $shipToCountryCode = "PT"; // Please refer to the PayPal country codes in the API documentation
        $shipToZip = "Braga";
        $phoneNum = "919254087";
        ...
        //'------------------------------------
        $returnURL = "http://taraserver.no-ip.org/funcionalidades/sucessshop.html";
        ...
        //' This is set to the value entered on the Integration Assistant 
        //'------------------------------------
        $cancelURL = "http://taraserver.no-ip.org/funcionalidades/cancelshop.html";
