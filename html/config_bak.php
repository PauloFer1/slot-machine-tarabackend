...
// Database settings:
define('DB_DSN', 'mysql:dbname=heroku_6aec58544eb5139;host=us-cdbr-east-02.cleardb.com;port=3306');
define('DB_USER', 'b0b97649278e32');
define('DB_PASS', '151dca02');
...
define('SITE_NAME', 'quiet-island-92724.herokuapp.com');
...
define( 'SERVER_URL', 'quiet-island-92724.herokuapp.com/');
