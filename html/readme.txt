# tarambola CMS - INFORMATION

## About

tarambola CMS began as migration of Radiant CMS from Ruby-on-Rails to PHP.
...
for more details on the exception tarambola CMS makes on the GNU GPL version 3.

The official tarambola website can be found at www.madebytarambola.com - visit it for more
...
- PHP 5
    ...
    - PHP: tarambola CMS does *not* run on PHP 4.
...
- tarambola CMS can also run on SQLite 3 as the database.
