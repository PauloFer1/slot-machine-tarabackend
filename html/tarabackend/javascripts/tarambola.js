...
/**
 * tarambola CMS - Content Management. <http://www.tarambola.pt>
 *
...
Object.extend(String.prototype, {
  ...
  toSlug: function()
  {
    return this.strip().downcase()
        .replace(/[àâáã]/g,"a").replace(/[éèêë]/g,"e").replace(/[îïíì]/g,"i")
        .replace(/[ôóò]/g,"o").replace(/[ùûú]/g,"u").replace(/[ñ]/g,"n")
        .replace(/[äæ]/g,"ae").replace(/[öø]/g,"oe").replace(/[ü]/g,"ue")
        .replace(/[ß]/g,"ss").replace(/[å]/g,"aa").replace(/[ç]/g,"c")
