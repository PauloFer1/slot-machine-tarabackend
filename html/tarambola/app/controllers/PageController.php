...
class PageController extends Controller
{
    ...
    public function edit($id=null)
    {
        ...
        if ( ! AuthUser::hasPermission('administrator') && ! AuthUser::hasPermission('developer') && $page->is_protected)
        {
         ...
         if( ($page->keywords=="tara_formulario" || $page->keywords=="tara_formulario_alt") && $page->description!="tara_read")
                {
                        $p = Record::findByIdFrom('Page', $page->id);
                        $p->toReadForm($page->id);
                }
        // check if trying to save
        if (get_request_method() == 'POST')
    ...
    private function _edit($id)
    {
        ...
        if( ($page->keywords=="tara_formulario_alt") && $page->description!="tara_read")
        {
            $page->description="tara_read";
        }
