                ...
                <table id="plugins" class="index" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tbody>
                        ...
                        <?php foreach (Plugin::findAll() as $plugin): ?>
                            <?php $disabled = (isset($plugin->require_tarambola_version) and $plugin->require_tarambola_version > tarambola_VERSION); ?>
                            <tr<?php if ($disabled) echo ' class="disabled"'; ?>>
                                <td class="plugin">
                                    ...
                                    <p><?php echo $plugin->description; ?> <?php if ($disabled) echo '<span class="notes">' . __('This plugin CANNOT be enabled! It requires tarambola version :v.', array(':v' => $plugin->require_tarambola_version)) . '</span>'; ?></p>
                                </td>
                ...
                <form action="<?php echo get_url('setting'); ?>" method="post">
                    <table class="fieldset" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                            ...
                            <td class="help"><?php echo __('This will set your language for the backend.'); ?><br /><?php echo __('Help us <a href=":url">translate tarambola</a>!', array(':url' => get_url('translate'))); ?></td>
                        </tr>
                        <tr>
