...
* In index.php, change the value of require_tarambola_version into a non-existant
  tarambola version and look at the plugins list (in the administration section)
  again.
