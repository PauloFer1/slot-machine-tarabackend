...
<p>If you want to use Image Resize with tarambola&#8217;s Page Not Found plugin, you will have to include the following code at the top of your customized Page Not Found page:</p>
...
<li>You set the variable <code>USE_MOD_REWRITE</code> in tarambola&#8217;s config.php to true.</li>
</ul>


<h3>How does it work?</h3>

<p>This module relies on some <code>mod_rewrite</code> magic: If the requested thumbnail exists, Apache knows this and delivers the file to the browser. If the file doesn't exist, Apache hands control over to tarambola CMS.</p>

<p>tarambola won't find the file either, so it sends a <code>page_not_found</code> message. This is the moment where the Image Resize plugin suddenly feels responsible. It checks whether an image without the dimension specifier exists (<code>flower.jpg</code>) and converts it into a thumbnail with the requested name (<code>flower.230x150.jpg</code>). The next time someone asks for that file it will be there!</p>

<h3>About this plugin</h3>

<p>This plugin was created by <a href="http://www.naehrstoff.ch">Peter Gassner</a> for the deliciously small and elegant <a href="http://madebytarambola.com">tarambola CMS</a>.</p>

<p>It was inspired by the Drupal <a href="http://drupal.org/project/imagecache">Image Cache</a> module. The image resize functions are taken from <a href="http://drupal.org/">Drupal</a> and adapted for tarambola CMS.</p>
