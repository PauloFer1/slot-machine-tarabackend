...
_createStyleSelect:function(m){
    var j=this,i=j.editor,k=i.controlManager,l=k.createListBox("styleselect",{
        title:"advanced.style_select",
        onselect:function(n){
            if(l.selectedValue===n){
                i.execCommand("mceSetStyleInfo",0,{
...
_createFontSizeSelect:function(){
    ...
    n=k.controlManager.createListBox("fontsizeselect",{
        ...
        onselect:function(i){
            ...
            k.editorCommands._applyInlineStyle("span",{
                "class":i["class"]
                },{
                check_classes:j
            })
    ...
    if(w.theme_advanced_resizing){
        ...
        if(w.theme_advanced_resizing_use_cookie){
            ...
            b.add(p.id+"_resize","mousedown",function(x){
                ...
                t=d.add(d.get(p.id+"_parent"),"div",{
...
if(z.theme_advanced_path&&z.theme_advanced_statusbar_location){
    i=d.get(l.id+"_path")||d.add(l.id+"_path_row","span",{
        id:l.id+"_path"
        });
    d.setHTML(i,"");
...
_mceInsertAnchor:function(k,j){
    ...
    i.windowManager.open({
        url:e.baseURL+"/themes/advanced/anchor.htm",
...
_mceCharMap:function(){
    var i=this.editor;
    i.windowManager.open({
        url:e.baseURL+"/themes/advanced/charmap.htm",
...
_mceHelp:function(){
    var i=this.editor;
    i.windowManager.open({
        url:e.baseURL+"/themes/advanced/about.htm",
        width:480,
        height:380,
        inline:true
    },{
...
_mceColorPicker:function(k,j){
    ...
    i.windowManager.open({
        url:e.baseURL+"/themes/advanced/color_picker.htm",
...
_mceCodeEditor:function(j,k){
    var i=this.editor;
    i.windowManager.open({
        url:e.baseURL+"/themes/advanced/source_editor.htm",
...
_mceImage:function(j,k){
    ...
    i.windowManager.open({
        url:e.baseURL+"/themes/advanced/image.htm",
...
_mceLink:function(j,k){
    var i=this.editor;
    i.windowManager.open({
        url:e.baseURL+"/themes/advanced/link.htm",
