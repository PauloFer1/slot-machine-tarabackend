...
<table cellpadding="5">
		<tr>
			...
			<td>
				<input type="text" name="mem_email" id="email" value="">
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<input type="text" name="mem_first_name" id="first_name" value="">
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<input type="text" name="mem_last_name" id="last_name" value="">
			</td>
		</tr>
		<!--<tr>
			<td>
