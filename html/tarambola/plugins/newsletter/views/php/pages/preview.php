...
if(isset($_REQUEST['iframe']) && !$errors)
	...
	<h2>Small Preview: (the one that gets emails)</h2>
        "<?php echo(URL_PUBLIC); ?>tarambola/plugins/newsletter/views/index.php?p=preview&small&iframe=true&newsletter_id=<?php echo $newsletter_id;?>
        <iframe src="<?php echo(URL_PUBLIC); ?>tarambola/plugins/newsletter/views/index.php?p=preview&small&iframe=true&newsletter_id=<?php echo $newsletter_id;?>" frameborder="0" style="border:1px solid #CCCCCC; width:100%; height:600px;"></iframe>
	<h2>Full Preview: (the one that appears on website /  click to view online)</h2>
	<iframe src="plugin/newsletter?p=preview&full&iframe=true&newsletter_id=<?php echo $newsletter_id;?>" frameborder="0" style="border:1px solid #CCCCCC; width:100%; height:600px;"></iframe>
