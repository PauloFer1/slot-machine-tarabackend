...
if($_REQUEST['save']){
	...
	ob_end_clean();
	header("Location: ".URL_PUBLIC."tarabackend/plugin/newsletter?p=settings");
	exit;
...
<form action="plugin/newsletter?p=settings&save=true" method="post" id="create_form">


<h2 class="recent"><span>All Settings (beta)</span></h2>
...
<div class="box">
	...
	<input type="submit" name="save" value="Salvar settings">
</div>
...
<h2 class="recent"><span>Embed Subscribe Form</span></h2>
...
<h2 class="recent"><span>Sending CRON Job (beta)</span></h2>
<div class="box">
...
<h2 class="recent"><span>Bounce Checking CRON Job (beta)</span></h2>
<div class="box">
