...
<a href="plugin/newsletter?p=open&newsletter_id=<?php echo $newsletter_id;?>">&laquo; Back to newsletter</a>

<h2><span>Newsletter Link Clicks:</span></h2>

<!-- <iframe src="plugin/newsletter?p=stats&iframe=true&newsletter_id=<?php echo $newsletter_id;?>&send_id=<?php echo $send_id;?>" frameborder="0" style="border:1px solid #CCCCCC; width:700px; height:600px;"></iframe> -->
