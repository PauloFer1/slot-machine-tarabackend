...
<?php foreach($page_part_forms as $page_part_form) { ?>
  <li id="<?php echo $css_id_prefix . $page_part_form->id; ?>" class="page_part_form node <?php echo odd_even(); ?>">
    <img align="middle" alt="<? echo __('Page part form'); ?>" src="../tarambola/plugins/<?php echo $plugin_id; ?>/images/page_part_form.png" title="" />
    
    <a href="<?php echo $plugin_url.'edit/'.$page_part_form->id; ?>"><?php echo $page_part_form->name; ?></a>
    
    <img class="handle" src="<? echo(URL_PUBLIC) ?>tarabackend/images/drag.gif" alt="<?php echo __('Drag and Drop'); ?>" align="middle" />
