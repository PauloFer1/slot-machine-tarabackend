...
tinyMCE.init({
    mode : "none",
	theme : "advanced",
	plugins : "table,fullscreen,preview,contextmenu,advimage,ibrowser,safari",
	...
	theme_advanced_buttons2 : "tablecontrols,|,hr,removeformat,|,outdent,indent,blockquote,|,preview,ibrowser",
