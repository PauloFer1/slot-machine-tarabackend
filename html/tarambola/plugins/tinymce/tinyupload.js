function tinyupload(field_name, url, type, win){
	...
	*/
	...
	CONFIG
	*/
	var pathToPhp = window.location.protocol+"//"+window.location.host+'/tarambola/plugins/tinymce/tinyupload.php';
	/*
	...
	*/
	...
	el2.style.cssText = 'height:50px;width:300px;background:#ffffff;border-width:0px;';
