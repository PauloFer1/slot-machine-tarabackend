...
//###### Config ######
$absPthToSlf = URL_PUBLIC.'tarambola/plugins/tinymce/tinyupload.php'; //The Absolute path (from the clients POV) to this file.
$absPthToDst = URL_PUBLIC.'public/images/'; //The Absolute path (from the clients POV) to the destination folder.
$absPthToDstSvr = SERVER_URL.'public/images/'; //The Absolute path (from the servers POV) to the destination folder. You will need to set permissions for this dir 0777 worked ok for me.
