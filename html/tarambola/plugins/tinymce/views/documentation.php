...
<p>
<?php echo __('This feature allows you to easily link to pages in tarambola from within the TinyMCE editor.');?>
</p>
...
<li><?php echo __('Click on the dropdown box and select an internal tarambola page where you want to link to.');?></li>
